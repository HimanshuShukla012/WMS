  ...
  {[
    {
      ...
      value: 48,
      icon: faWater,
      subtext: "2 newly constructed this month",
      bg: "bg-[#1E3A8A]", // Deep Blue
      iconBg: "bg-[#3B82F6]", // Bright Blue
      textColor: "text-white",
    },
    {
      title: "Active Pumphouses",
      value: 31,
      icon: faBolt,
      subtext: "All functioning properly",
      bg: "bg-[#065F46]", // Emerald/Dark Teal
      iconBg: "bg-[#10B981]", // Bright Emerald
      textColor: "text-white",
    },
    {
      title: "Inactive Pumphouses",
      value: 4,
      icon: faCircleExclamation,
      subtext: "Reported for maintenance",
      bg: "bg-[#7C2D12]", // Deep Red
      iconBg: "bg-[#F87171]", // Soft Red
      textColor: "text-white",
    },
  ].map((card, index) => (
    <div
