...
const Login = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/background.jpg')" }} // ✅ Update your path
    >
      {/* Dark overlay */}
      ...
      <div className="relative z-10 w-full md:w-1/2 max-w-xl flex flex-col gap-6 bg-gray-900/80 p-10 md:p-14 rounded-3xl shadow-2xl">
        <img src="/logo.png" alt="logo" className="w-24 md:w-28 mx-auto" /> {/* Extra big logo */}
      ...
      {/* Right Side Heading - Still clean and impressive */}
